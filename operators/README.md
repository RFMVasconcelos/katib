...
> Note: As a default, when you `juju deploy` an application or the full Katib bundle, you will deploy the latest released version of Katib, even if unreleased updates are already available. If you would like to try the latest available charm run `juju deploy foo --channel=edge`.
